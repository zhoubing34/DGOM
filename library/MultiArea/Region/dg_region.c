...
static void dg_region_node(dg_region *region){
    ...
    dg_grid *grid = dg_region_grid(region);
...
/**
 * @brief calculate the area and length of the 2D cell
 * @param[in,out] region
 */
static void dg_region_scale2d(dg_region *region){
    dg_cell *cell = dg_region_cell(region);
...
/**
 * @brief calculate the volume and length of the 3D cell
 * @param[in,out] region
 */
static void dg_region_scale3d(dg_region *region){
    const int Np = dg_cell_Np(dg_region_cell(region));
    const int K = dg_grid_K(region->grid);
