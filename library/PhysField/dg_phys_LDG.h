...
typedef struct dg_phys_LDG{
    ...
    dg_real *miux, *miuy, *miuz; ///< sqrt root of viscosity;
} dg_phys_LDG;
...
#define dg_phys_ldg_sqrt_miux(ldg) (ldg->miux)
#define dg_phys_ldg_sqrt_miuy(ldg) (ldg->miuy)
#define dg_phys_ldg_sqrt_miuz(ldg) (ldg->miuz)
